...
add_interface_port conduit_end streamSink_asi_be be Input 8
add_interface_port conduit_end streamSink_asi_parity parity Input 8
add_interface_port conduit_end streamSink_asi_bar bar Input 8
